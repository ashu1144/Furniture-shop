    ...
    <div className='p-5 max-sm:p-2 '>
        <div className='font-light flex justify-between max-w-[75vw] max-sm:w-full max-sm:m-0 m-auto items-center'>
            ...
            <div className='flex gap-5 max-sm:px-4 max-sm:py-0 max-sm:gap-2 items-center'>
                <div className=' max-sm:text-xs max-sm:p-2 w-26 font-semibold border-2 border-zinc-200 rounded-2xl p-2 cursor-pointer hover:bg-green-950 hover:text-white ease-in-out duration-300 transition-all '>All Categories</div>
